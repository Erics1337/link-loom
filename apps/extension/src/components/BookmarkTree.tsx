...
import { collectFolderMoveOptions, FolderMoveOption } from '../lib/bookmarkStructure';
...
}> = ({ node, defaultExpanded, depth, onRenameNode, onMoveBookmark, folderOptions }) => {
    ...
    return (
        <div className="select-none">
            ...
            >
                ...
                {!isEditingTitle && (onRenameNode || canMove) && (
...
export const BookmarkTree: React.FC<BookmarkTreeProps> = ({ nodes, defaultExpanded = false, onRenameNode, onMoveBookmark }) => {
