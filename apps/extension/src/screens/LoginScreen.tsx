...
export const LoginScreen: React.FC<LoginScreenProps> = ({
  ...
  return (
    <div className="app-shell">
      ...
      <div className="app-scroll flex flex-col gap-3">
        <div className="card">
          <div
            className="grid"
          ...
          >
            <button
              ...
              className={`btn ${mode === "sign-in" ? "btn-primary" : "btn-secondary"}`}
              type="button"
            >
              Sign In
            </button>
            <button
              ...
              className={`btn ${mode === "sign-up" ? "btn-primary" : "btn-secondary"}`}
              type="button"
            >
              Sign Up
            </button>
        ...
        {mode === "sign-in" && (
          <div className="card flex flex-col gap-3">
            ...
            <div className="relative text-center">
              <span className="text-xs text-secondary bg-[var(--surface-color)] px-2 relative z-10">
                or use email
              </span>
              <div
                className="absolute inset-x-0 top-1/2 border-t border-[var(--border-color)]"
                aria-hidden="true"
              />
            </div>
          </div>
              ...
              {[
                {
                  id: "free" as const,
                  title: "Free Plan",
                  copy: "Up to 500 bookmarks",
                },
                {
                  id: "paid" as const,
                  title: "Pro Lifetime",
                  copy: "Unlimited bookmarks and Pro tools",
                },
              ].map((item) => (
                <button
                  key={item.id}
                ...
                >
                  <span className="badge">
                    {plan === item.id ? <Check size={12} /> : null}
                  </span>
