    ...
    <div className="app-shell">
      ...
      <section className="panel">
        ...
        <p className="screen-copy mt-3">
          Turn saved links into a searchable folder map before bookmark clutter
          takes over.
        </p>
      </section>
      ...
      <section className="card space-y-3">
        ...
        <div
          className="grid"
          style={{ gridTemplateColumns: hasCachedResults ? "1fr 1fr" : "1fr" }}
        >
          {hasCachedResults && (
        ...
        {importStructureMessage && (
          <div
            className={`message ${importStructureMessage.kind === "error" ? "message-error" : "message-success"}`}
          >
      ...
      <section className="card mt-auto">
        {isLoggedIn ? (
          <div className="space-y-3">
            ...
            {cloudSnapshotsError && (
              <div className="message message-error">{cloudSnapshotsError}</div>
            )}
          </div>
        ) : (
          <div className="space-y-3">
            <div>
              ...
              <p className="screen-copy">
                Organize up to 500 bookmarks without signing in. Create a free
                account for Cloud Snapshots and plan sync.
              </p>
            </div>
