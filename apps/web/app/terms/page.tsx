        ...
        <div className="space-y-6">
          <Section title="Overview">
            <p>
              ...
              software service that helps users organize and search bookmarks
          ...
          <Section title="Payments, Pricing, and Billing">
            <p>
              Paid features are billed in U.S. dollars (USD) through Stripe.
              Pricing may include recurring subscriptions and/or one-time
              license offers as presented at checkout.
            </p>
            <p>
              By completing a purchase, you authorize the applicable payment and
              any recurring charges associated with your selected plan until
              canceled.
            </p>
          </Section>
          ...
          <Section title="Cancellation and Refunds">
            <p>
              Subscription cancellation and refund terms are described in our
              public Refund and Cancellation Policy.
            </p>
            <p>
          ...
          <Section title="Intellectual Property">
            <p>
              Link Loom and related branding, software, and site content are
              owned by Link Loom or its licensors, except for content provided
              by users.
            </p>
          </Section>
          ...
          <Section title="Disclaimer and Limitation of Liability">
            <p>
              ...
              available&quot; basis to the extent permitted by law. To the
              maximum extent permitted by law, Link Loom disclaims implied
